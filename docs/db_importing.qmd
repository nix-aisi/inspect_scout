...
[OpenClaw](https://openclaw.ai) is an open-source AI assistant. Scout can import transcripts from JSONL telemetry files written by the third party [`openclaw-telemetry-hal`](https://github.com/sage-princeton/openclaw-telemetry-hal) plugin (by default to `~/.openclaw/logs/telemetry.jsonl`).
...
`openclaw-telemetry-hal` is a third party plugin.
:::
