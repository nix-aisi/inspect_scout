...
4. [OpenClaw](#openclaw): Read transcript data from OpenClaw telemetry files captured with the `openclaw-telemetry-hal` plugin.
...
Native OpenClaw session files (the bundles under `~/.openclaw/`) are not yet supported.
